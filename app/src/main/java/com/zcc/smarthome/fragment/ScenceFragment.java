        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                for (int i = 0; i < jsonArray.size(); i++) {
                    ...
                    beanList.add(new ScencesListBean().setStrategyId(jsonObject.getString("StrategyId")).setTitle(jsonObject.getString("ConditionCn")));
                }
                rV_Mode(false);
            } else if (msg.what == 2) {
        ...
        OkHttpUtils.getInstance().getStrategys("1", new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    handler.obtainMessage(1, jsonArray).sendToTarget();
                }
            }
        });
            ...
            mScenceAdapter.setOnLaunchClickListener(new mRecyclerViewMyScenceAdapter.OnLaunchClickListener() {
                ...
                public void onClick(int position) {
                    ...
                    OkHttpUtils.getInstance().setEnable(id, Math.random() < 0.5 ? "true" : "false", new Callback() {
                        ...
                        @Override
                        public void onResponse(Call call, Response response) throws IOException {
                            handler.obtainMessage(2, "开启成功").sendToTarget();
