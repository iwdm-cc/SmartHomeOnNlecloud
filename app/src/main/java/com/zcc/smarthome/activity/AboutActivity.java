...
import com.zcc.smarthome.view.BubbleView;
...
public class AboutActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        OIViewUpdata = findViewById(R.id.OIViewUpdata);
        mOIViewState = findViewById(R.id.OIViewState);
        mOIViewOpinion = findViewById(R.id.OIViewOpinion);
        mOIViewAbout = findViewById(R.id.OIViewAbout);
        mOIViewShare = findViewById(R.id.OIViewShare);
        ...
        mPullScrollView = findViewById(R.id.mPullScrollView);
