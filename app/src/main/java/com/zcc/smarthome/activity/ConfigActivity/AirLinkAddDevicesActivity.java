package com.zcc.smarthome.activity.ConfigActivity;
...
import com.zcc.smarthome.adapter.mPagerAdapter;
import com.zcc.smarthome.constant.Constant;
import com.zcc.smarthome.utils.L;
import com.zcc.smarthome.utils.NetStatusUtil;
import com.zcc.smarthome.utils.SharePreUtils;
import com.zcc.smarthome.utils.ToastUtils;
import com.zcc.smarthome.view.GifView;
import com.zcc.smarthome.view.NoScollViewPager;
import com.zcc.smarthome.view.RippleView;
import com.zcc.smarthome.view.StepsView;
...
import static com.zcc.smarthome.constant.Constant.SoftAP_Start;
...
public class AirLinkAddDevicesActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        btnNext = View1.findViewById(R.id.btnNext);
        ...
        etSSID = View1.findViewById(R.id.etSSID);
        etPsw = View1.findViewById(R.id.etPsw);
        ...
        //密码显示操作
        CheckBox cbLaws = View1.findViewById(R.id.cbLaws);
        ...
        tv_Message = View2.findViewById(R.id.tv_Message);
        tv_Message.setOnClickListener(this);

        //第三个View
        tv_Progress = View3.findViewById(R.id.tvShowProgress);
        tvShow = View3.findViewById(R.id.tvShow);

        mRippleView = View3.findViewById(R.id.mRippleView);
