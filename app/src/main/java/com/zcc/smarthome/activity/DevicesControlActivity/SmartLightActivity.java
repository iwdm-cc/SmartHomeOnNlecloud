...
public class SmartLightActivity extends BaseDevicesControlActivity implements View.OnClickListener {
    ...
    //ui
    private com.zcc.smarthome.view.SeekBarColorPicker mMSeekbarColorPicker;
    ...
    protected void bindView() {
        ...
        //色环
        mMSeekbarColorPicker = (com.zcc.smarthome.view.SeekBarColorPicker) findViewById(R.id.mSeekbarColorPicker);
